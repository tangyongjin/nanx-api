...
class CodeReview extends CI_Controller {
    ...
    private $func_exclude = ['__construct'];

    private $file_exclude = ['CodeReview.php'];
    ...
    public function index() {
        ...
        // $merged_files = array_merge($view_files, $controller_files);
        ...
        foreach ($files_source as $file_source) {
            ...
            foreach ($file_source_functions as $function_source_name) {
                ...
                if (!isset($file_source['functions_with_usage'][$function_source_name]['usage'])) {
                    $file_source['functions_with_usage'][$function_source_name]['usage'] = [];
                }
